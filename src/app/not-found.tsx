...
export const metadata: Metadata = {
  title: "Página no encontrada | Los Lagos Hotel",
  description:
    "La página que buscás no existe o fue movida. Volvé al inicio de Los Lagos Hotel, El Calafate.",
};
    ...
    <div className="flex min-h-screen flex-col bg-[#f7f3ea]">
      <main className="flex flex-1 items-center justify-center px-5 py-16 sm:px-8">
        <div className="w-full max-w-md text-center">
          ...
          <p className="mt-4 text-sm leading-6 text-[#5f6e69]">
            La página que buscás no existe o fue movida. Te ayudamos a volver al
            camino correcto.
          </p>
